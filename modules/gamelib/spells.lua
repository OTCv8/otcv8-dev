...
SpellInfo = {
  ['Default'] = {
    ...
    ['Chivalrous Challenge'] =     {id = 101, words = "exeta amp res",         exhaustion = 2000,  premium = true,  type = 'Instant', icon = 'chivalrouschallanger',   mana = 80,     level = 150,soul = 0, group = {[3] = 2000},               vocations = {8}},
    ...
    ["Nature's Embrace"] =         {id = 101, words = 'exura sio',             exhaustion = 60000, premium = true,  type = 'Instant', icon = 'naturesembrace',         mana = 400,    level = 300,soul = 0, group = {[2] = 1000},               vocations = {2, 6}},
