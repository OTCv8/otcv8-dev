...
Panel
  ...
  function defaultRingFind()
    if storage[panelName].ringEnabled then
      if getFinger() and (getFinger():getId() ~= storage[panelName].ringId and getFinger():getId() ~= getAlternateId(storage[panelName].ringId)) then
  ...
  function defaultAmmyFind()
    if storage[panelName].ammyEnabled then
      if getNeck() and (getNeck():getId() ~= storage[panelName].ammyId and getNeck():getId() ~= getAlternateId(storage[panelName].ammyId)) then
  ...
  macro(20, function()
    ...
    local ringEquipped = getFinger() and (getFinger():getId() == storage[panelName].ringId or getFinger():getId() == getAlternateId(storage[panelName].ringId))
    ...
    local ammyEquipped = getNeck() and (getNeck():getId() == storage[panelName].ammyId or getNeck():getId() == getAlternateId(storage[panelName].ammyId))
